    ...
    [12], {
        ...
        "0lfv": function(e, t, n) {
            ...
            var r = n("s8DI"),
                ...
                D = function error(e, t) {
                    ...
                    Object(g.a)(error, t),
                        function errorHandler(e) {
                            if (A || error instanceof l.a) throw e;
                            y({
                                type: "warn",
                                data: [e.message],
                                internal: n
                ...
                U = function byId(e) {
                    return Object(b.a)(Object(v.a)(Object(p.a)("id"), e), e)
                },
                k = function byCampaignId(e) {
                    return Object(b.a)(Object(v.a)(Object(p.a)("campaignId"), e), e)
                },
        ...
        "4c+F": function(e, t, n) {
            ...
            var r = n("nfbA"),
                ...
                b = function _formatBucketName(e) {
                    return e.toLowerCase().replace(/ /g, "_")
                },
                v = function _getMetricPrefix(e) {
                    ...
                    var e = Object(c.a)(a.a.mark(function _callee(e) {
                        ...
                        return a.a.wrap(function _callee$(a) {
                            for (;;) switch (a.prev = a.next) {
                                ...
                                case 9:
                                    return a.prev = 9, a.t0 = a.catch(2), i = Object(s.a)("", ["name"], n), Object(l.v)(["Failed to broadcast message ".concat(t, " - ").concat(i), n, a.t0]), a.abrupt("return", {});
                                case 14:
                                case "end":
                                    return a.stop()
                            }
        ...
        "9xv8": function(e, t, n) {
            ...
            var r = n("8lq6"),
                ...
                b = function orderConversationLastMessagesBy(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "updatedAt";
                    return Object(r.a)([Object(a.a)(Object(o.a)(["lastMessage", "".concat(t)]))])(e)
                },
                v = function messagesByWidgetGuid(e) {
                    return Object(f.l)(e) ? {} : Object(i.a)(Object(c.a)(Object(u.a)(Object(s.a)(["attributes", "widgetGuid"]), Object(o.a)(["attributes", "widgetGuid"]), Object(o.a)(["id"])), e), e)
                },
                p = function filterUnwantedMessageTypes(e, t) {
                    return Object(f.l)(e) ? [] : Object(l.a)(function(e) {
        ...
        EQxi: function(e, t, n) {
            ...
            var r = n("mpTe"),
                ...
                v = function hasUnwantedTLD(e) {
                    var t = function getTLD(e) {
                        try {
                            ...
                            return Object(f.v)(["".concat(a)]), null
                        }
                    }(e);
                    return !!Object(f.l)(t) || b.some(function(e) {
                        return Object(i.a)(e, t.toLowerCase())
                    })
                },
                p = /<a href=/gi,
                O = /(\s|^)(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)?([a-z0-9]+)([-.]{1}[a-z0-9]+)*(\.[a-z]{2,5})(:[0-9]{1,5})?([-a-zA-Z\d:%\/_+.~#*$!?&=@]*)([,](?![\s]))*/gm,
                E = function linkifyMessageBody(e) {
                    return e = e.replace(p, '<a target="_blank" rel="noopener noreferrer" href='), Object(d.a)(e, !1) ? e : e.replace(O, function(e, t, n, r, a, o, c, i) {
                ...
                h = Object(u.a)(s.a, function(e) {
                    return Object(f.l)(e) || !Object(l.a)(String, e) ? e : e.replace(/&#61;/g, "=").replace(/&#x2F;/g, "/").replace(/&#64;/g, "@").replace(/&amp;/g, "&").replace(/<\//g, " </")
                }),
                m = function getUrlObjectsFromText(e) {
                    ...
                    return (a()({
                        ...
                        return !Object(d.a)(e.url, !1) && !v(e.url)
                    })
                },
                g = function getUrlStringsFromText(e) {
                    try {
                        ...
                        return Object(f.v)(["Failed to get urls from text", e, t]), []
                    }
                },
                ...
                T = function normalizeProtocolForUrl(e) {
                    ...
                    try {
                        ...
                        return Object(f.v)(["Failed to normalize protocol for url"]), ""
                    }
                },
                A = function normalizeDriftUrl(e) {
                    if (!e) return "";
                    try {
                        return c()(e, {
                            normalizeProtocol: !0,
                ...
                S = function parseAndAddLinks(e) {
                    var t = m(e);
                    if (Object(f.l)(t)) return e;
                    for (var n = e, r = t.length - 1; r >= 0; r--) {
                        ...
                        n = Object(f.r)(a.index, a.lastIndex, n, c)
                    }
                    return n
                }
        },
                    ...
                    var e = Object(o.a)(a.a.mark(function _callee(e, t) {
                        ...
                        return a.a.wrap(function _callee$(a) {
                            for (;;) switch (a.prev = a.next) {
                                ...
                                case 13:
                                    return a.prev = 13, a.t0 = a.catch(5), Object(i.m)({
                                        type: "warn",
            ...
            var r = n("4bA0"),
                ...
                i = function parseHtmlText(e) {
                    ...
                    try {
                        ...
                        return Object(c.v)(["Failed to parse html text", e, t]), e
                    }
                }
        },
        MFhO: function(e, t, n) {
        ...
        QX29: function(e, t, n) {
            ...
            var r = n("1FNf"),
                ...
                b = n("pu/X"),
                v = n("DboL"),
                p = ["loading chunk", "loading CSS chunk", "Could not broadcast message with topic", "No ack for postMessage", "No handler found for post message", "Cannot find timezone", "Request failed with status code"].concat(Object(d.a)(Object(v.a)(b.a.MESSAGE))),
                O = [].concat(["grecaptcha", "BetterJSPop", "csPostMessage", "GM_getTab is not a function", "Cannot redefine property: googletag", "angular is not defined", "$ is not defined", "jQuery is not defined", "ns.GetCommandSrc", "NO ACCESS ON THIS DOMAIN", "the operation is insecure", "NS_ERROR", "Access is denied", "SecurityError: SecurityError", "NS_ERROR_ILLEGAL_VALUE", "tryLogin is not defined", "closeOnScreenKeyboard", "grecaptcha is not defined", "BetterJsPop", "doLogin is not defined"], ["isTrusted", "Object Not Found Matching Id:", "ResizeObserver loop limit exceeded", "ResizeObserver loop completed with", "undelivered", "timeout of 0ms exceeded", "network error", "out of memory"], ["Failed to get bootstrap-api response - Request failed with status code", "Failed to get ping information from bootstrap - Request failed with status code", "Received null access token from widget auth"], p),
                E = ["headless", "DejaClick", "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/602.1 (KHTML, like Gecko) JavaFX/8.0 Safari/602.1", "Firefox/52.0", "JavaFX"];
            n.d(t, "a", function() {
                return g
            });
            var h;
            "LOCAL" !== o.a.ENV && Object(a.a)({
                ...
                maxBreadcrumbs: 50,
                attachStacktrace: !0,
                release: "widget-core@ 97425df4972c618e5a11d6b4ec2bbad29dcc41af",
                environment: o.a.ENV,
        ...
        VpmR: function(e, t, n) {
            ...
            var r = n("mj2O"),
                ...
                b = function importByLocale() {
                    switch (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "en") {
                        case "da":
                            return n.e(45).then(n.t.bind(null, "NlHF", 3));
                        case "de":
                            return n.e(46).then(n.t.bind(null, "xciK", 3));
                        case "es":
                            return n.e(48).then(n.t.bind(null, "E4Qo", 3));
                        case "et":
                            return n.e(49).then(n.t.bind(null, "LfcA", 3));
                        case "fi":
                            return n.e(50).then(n.t.bind(null, "hxpe", 3));
                        case "fr":
                            return n.e(51).then(n.t.bind(null, "4odN", 3));
                        case "hi":
                            return n.e(52).then(n.t.bind(null, "/VOv", 3));
                        case "hr":
                            return n.e(53).then(n.t.bind(null, "nuYs", 3));
                        case "hu":
                            return n.e(54).then(n.t.bind(null, "vvtZ", 3));
                        case "is":
                            return n.e(55).then(n.t.bind(null, "lGT2", 3));
                        case "it":
                            return n.e(56).then(n.t.bind(null, "JzFs", 3));
                        case "ja":
                            return n.e(57).then(n.t.bind(null, "N6oZ", 3));
                        case "ko":
                            return n.e(58).then(n.t.bind(null, "EA3l", 3));
                        case "nb":
                            return n.e(59).then(n.t.bind(null, "/p8F", 3));
                        case "nl":
                            return n.e(60).then(n.t.bind(null, "xW0c", 3));
                        case "pl":
                            return n.e(61).then(n.t.bind(null, "lWhz", 3));
                        case "pt":
                        case "pt-PT":
                            return n.e(63).then(n.t.bind(null, "2nBd", 3));
                        case "pt-BR":
                            return n.e(62).then(n.t.bind(null, "+94T", 3));
                        case "ro":
                            return n.e(64).then(n.t.bind(null, "tDBS", 3));
                        case "ru":
                            return n.e(65).then(n.t.bind(null, "wywo", 3));
                        case "sl":
                            return n.e(66).then(n.t.bind(null, "1oMb", 3));
                        case "sv":
                            return n.e(67).then(n.t.bind(null, "tBPe", 3));
                        case "th":
                            return n.e(68).then(n.t.bind(null, "Uso0", 3));
                        case "tr":
                            return n.e(69).then(n.t.bind(null, "Fagm", 3));
                        case "vi":
                            return n.e(70).then(n.t.bind(null, "FBrj", 3));
                        case "zh":
                            return n.e(72).then(n.t.bind(null, "JB1/", 3));
                        case "zh-HK":
                            return n.e(71).then(n.t.bind(null, "6wg5", 3));
                        case "en":
                        default:
                            return n.e(47).then(n.t.bind(null, "A/Ql", 3))
                    }
                },
                v = function() {
                    var e = Object(o.a)(a.a.mark(function _callee2(e) {
                        var t, r, u, l, f;
                        return a.a.wrap(function _callee2$(v) {
                            for (;;) switch (v.prev = v.next) {
                                case 0:
                                    return t = n("d5gM"), r = t.default, u = n("liE7"), l = u.initReactI18next, f = d(e), v.next = 5, r.use(c.a).use(l).init({
                                        lng: f,
                                        fallbackLng: "en",
                                        nsSeparator: !1,
                                        interpolation: {
                                                    ...
                                                    return a.a.wrap(function _callee$(t) {
                                                        for (;;) switch (t.prev = t.next) {
                                                            ...
                                                            case 3:
                                                                ...
                                                                break;
                                                            case 7:
                                                                t.prev = 7, t.t0 = t.catch(0), Object(s.v)(["Failed to fetch translations for locale: ".concat(e)]), o(null, {
                                                                    status: 500
                                                                });
                                                            case 11:
                                                            case "end":
            ...
            var r = n("Hvhg"),
                ...
                l = Object(i.a)(function() {
                    ...
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1,
                        t = Object(a.l)();
                    return function getRandomIds(e, t, n) {
                        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1;
                        if (Object(s.l)(e)) return [];
                        ...
                        if (u.length && (a = u), !a.length) return e[0].id;
                        var l = Object(s.g)(a.length, n);
                        return r > a.length && (r = a.length), l + r > a.length && (l = a.length - r), Object(c.a)(function(e) {
                            return a[l + e].id
                        }, r)
                    }(Object(r.f)([], ["configuration", "team"]), Object(r.f)([], ["configuration", "doNotDisturbUsers"]), t.sessionStarted, e)
                })
        }
    }
]);