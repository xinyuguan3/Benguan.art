        ...
        LaGA: function(e, t, n) {
            ...
            (function(e) {
                ...
                var a = 20,
                    ...
                    h = function defineConfigurable(e, t) {
                ...
                function getHTMLElementContentRect(e) {
                    ...
                    var r = f(e).getComputedStyle(e),
                        ...
                        a = toFloat(r.width),
                        c = toFloat(r.height);
                    if ("border-box" === r.boxSizing && (Math.round(a + i) !== t && (a -= getBordersSize(r, "left", "right") + i), Math.round(c + s) !== n && (c -= getBordersSize(r, "top", "bottom") + s)), ! function isDocumentElement(e) {
                    ...
                    return createRectInit(o.left, o.top, a, c)
                }
                ...
                function getContentRect(e) {
                    return r ? p(e) ? function getSVGContentRect(e) {
                        var t = e.getBBox();
                        return createRectInit(0, 0, t.width, t.height)
                    }(e) : getHTMLElementContentRect(e) : d
                }
                ...
                var k = "undefined" !== typeof o.ResizeObserver ? o.ResizeObserver : y;
                t.a = k
            }).call(this, n("fRV1"))
        },
        Maj3: function(e, t, n) {
            ...
            var s = n("wBll"),
                ...
                l = n("weY7"),
                h = Object(r.a)(function _xchain(e, t) {
                    return Object(l.a)(e, u(t))
                }),
                f = Object(r.a)(Object(o.a)(["fantasy-land/chain", "chain"], h, function chain(e, t) {
            ...
            var r = n("s8DI"),
                ...
                y = function() {
                    function Channel(e, t, n) {
                        var r = this;
                        Object(o.a)(this, Channel), this.state = d.closed, this.topic = e, this.params = s(t || {}), this.socket = n, this.bindings = [], this.bindingRef = 0, this.timeout = this.socket.timeout, this.joinedOnce = !1, this.joinPush = new b(this, p.join, this.params, this.timeout), this.pushBuffer = [], this.stateChangeRefs = [], this.rejoinTimer = new m(function() {
                            ...
                            r.socket.hasLogger() && r.socket.log("channel", "timeout ".concat(r.topic, " (").concat(r.joinRef(), ")"), r.joinPush.timeout), new b(r, p.leave, s({}), r.timeout).send(), r.state = d.errored, r.joinPush.reset(), r.socket.isConnected() && r.rejoinTimer.scheduleTimeout()
                    ...
                    return Object(i.a)(Ajax, null, [{
                        ...
                        value: function request(e, t, n, r, o, i, s) {
                            if (u.XDomainRequest) {
                                ...
                                this.xdomainRequest(a, e, t, r, o, i, s)
                            } else {
                                var c = new u.XMLHttpRequest;
                                this.xhrRequest(c, e, t, n, r, o, i, s)
                            }
                        }
                    }, {
                        key: "xdomainRequest",
                ...
                R = function() {
                    function LongPoll(e) {
                        Object(o.a)(this, LongPoll), this.endPoint = null, this.token = null, this.skipHeartbeat = !0, this.onopen = function() {}, this.onerror = function() {}, this.onmessage = function() {}, this.onclose = function() {}, this.pollEndpoint = this.normalizeEndpoint(e), this.readyState = h.connecting, this.poll()
                    }
                ...
                _ = function() {
                    function Socket(e) {
                        ...
                        Object(o.a)(this, Socket), this.stateChangeCallbacks = {
                            ...
                            error: [],
                            message: []
                        }, this.channels = [], this.sendBuffer = [], this.ref = 0, this.timeout = n.timeout || f, this.transport = n.transport || u.WebSocket || R, this.establishedConnections = 0, this.defaultEncoder = O.encode.bind(O), this.defaultDecoder = O.decode.bind(O), this.closeWasClean = !1, this.binaryType = n.binaryType || "arraybuffer", this.connectClock = 1, this.transport !== R ? (this.encode = n.encode || this.defaultEncoder, this.decode = n.decode || this.defaultDecoder) : (this.encode = this.defaultEncoder, this.decode = this.defaultDecoder);
                        var r = null;
                        ...
                        value: function onConnMessage(e) {
                            ...
                            this.decode(e.data, function(e) {
                                ...
                                for (var l = 0; l < t.stateChangeCallbacks.message.length; l++) {
                                    (0, Object(r.a)(t.stateChangeCallbacks.message[l], 2)[1])(e)
                                }
                            })
                        }
                    }, {
            ...
            var h = function(e) {
                    ...
                    return function LiveAnnouncer_inherits(e, t) {
                        ...
                        return o.a.createElement(l.Provider, {
                            value: s
                        }, this.props.children, o.a.createElement(u, {
                            assertiveMessage: r,
                ...
                function AnnouncerMessage() {
                    ...
                    return t = n = AnnouncerMessage_possibleConstructorReturn(this, e.call.apply(e, [this].concat(o))), n.announce = function() {
                        var e = n.props,
                            ...
                            i = e.announcePolite;
                        "assertive" === r && o(t || "", d()()), "polite" === r && i(t || "", d()())
